...
class BankAccountsControllerTest < ActionController::TestCase
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post :create, bank_account: { bank_account_number: @bank_account.bank_account_number, user_id: @bank_account.user_id }
    end
  ...
  test "should update bank_account" do
    patch :update, id: @bank_account, bank_account: { bank_account_number: @bank_account.bank_account_number, user_id: @bank_account.user_id }
    assert_redirected_to bank_account_path(assigns(:bank_account))
  end
