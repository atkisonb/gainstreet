...
class HoldingsControllerTest < ActionController::TestCase
  ...
  test "should create holding" do
    assert_difference('Holding.count') do
      post :create, holding: { fund_id: @holding.fund_id, shares: @holding.shares, stock_id: @holding.stock_id }
    end
  ...
  test "should update holding" do
    patch :update, id: @holding, holding: { fund_id: @holding.fund_id, shares: @holding.shares, stock_id: @holding.stock_id }
    assert_redirected_to holding_path(assigns(:holding))
  end
