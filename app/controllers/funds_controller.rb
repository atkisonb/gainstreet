class FundsController < ApplicationController
  ...
  private
    ...
    def fund_params
      params.require(:fund).permit(:fund_name, :fund_description, :fund_strategy, :strategy_why_i_buy, :strategy_why_i_sell, :strategy_allocation_discipline, :strategy_other_notes, :nav_shares, :user_account_id, :fund_manager_id)
    end
end
